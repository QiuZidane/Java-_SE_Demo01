...
public class TCPEchoClient {
	 ...
	 * 
	 */
	public static void main(String[] margs) throws UnknownHostException, IOException {

		String[] args = { "127.0.0.1", "Echo this 1234","9090" };
		...
		while (totalBytesRcvd < data.length) {
			if ((bytesRcvd = in.read(data, totalBytesRcvd, data.length - totalBytesRcvd)) == -1) { // 读取过程中，TCP连接被另一端关闭，read会返回-1，这里
