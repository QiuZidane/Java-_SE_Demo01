...
public class FileUtilTest {
    ...
    public void exceptionTest1() throws IllegalAccessException {
        ...
        throw new IllegalAccessException("Null1234");
    }

    @Test(expectedExceptions = IllegalAccessException.class, expectedExceptionsMessageRegExp = "Nullll", groups = {
            "exceptiontest"})
    public void exceptionTest2() throws IllegalAccessException {
        System.out.println("exceptionTest>>>");
